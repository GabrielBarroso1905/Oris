...
const RoadMissionsDashboard: React.FC<RoadMissionsProps> = ({ title }) => {
  ...
  const missions = useMemo<IMission[]>(() => [
    { title: 'Reconhecer Sintomas', stroke: 'stroke-blue-600', fill: 'fill-blue-200',   icon: 'ki-solid ki-heart', iconColor: 'text-blue-600', description: 'Aprenda a identificar sintomas de ansiedade.', type: 'reading', link: 'https://vidasaudavel.einstein.br/crise-de-ansiedade/', duration: '4 minutos', order: 1, points: 20, level: 'iniciante' },
